export const resMessage = {
  ...
  PASSWORD_CHANGED:
    "Password changed successfully. Please log in again to continue.",
  USER_SUBSCRIBE_SUCCESS:
    "Thank you for subscribing — welcome to the community!",
  USER_ACCESS_RESTRICTED:
    "Access denied. Your account has been restricted by the admin. For assistance or registration, please get in touch with the admin!",
  ...
  TAGS_FOUND:
    "A tags with this name already exists. Please choose a different name.",
